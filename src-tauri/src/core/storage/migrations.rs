...
pub static MIGRATIONS: &[Migration] = &[
    ...
    Migration {
        version: 29,
        name: "create_tournament_tables",
        // Tournament management: teams registered per event, the bracket /
        // schedule matches and the link to the live series a match starts.
