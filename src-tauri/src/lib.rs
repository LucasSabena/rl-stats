...
pub fn run() {
    ...
    let result = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::training_packs::list_training_packs,
            commands::training_packs::upsert_training_pack,
            commands::training_packs::delete_training_pack,
            ...
            commands::broadcast::list_team_roster,
            commands::broadcast::add_team_roster_player,
            commands::broadcast::remove_team_roster_player,
            ...
            commands::tournament::list_tournament_teams,
            commands::tournament::add_tournament_team,
            commands::tournament::remove_tournament_team,
            commands::tournament::set_tournament_team_checked_in,
            commands::tournament::generate_tournament_bracket,
